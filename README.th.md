...
อีโคซิสเต็ม — โครงสร้างพื้นฐานที่ค้ำจุนชีวิตประจำวันของครอบครัว เจ็ดตัวในนี้เปิดให้ใช้ได้แล้ววันนี้ และแผนที่ตรวจสอบตัวเองทุกสัปดาห์:
...
- **context-kit** — อุปกรณ์ประจำโต๊ะ 5 ชิ้นสำหรับเอเจนต์หนึ่งตัว จำกัดขนาดผลลัพธ์ของเครื่องมือ ตรวจสอบบรีฟก่อนมอบหมายงาน การ์ดกันคำสั่งทำลายข้อมูลและกุญแจหลุด ค้นความจำหลายชั้น — ออกแบบแบบ fail-open จึงไม่มีวันดึงเอเจนต์ล้มไปด้วย (เร็ว ๆ นี้)
