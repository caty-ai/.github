...
เรายังวัดด้วยว่าระบบนี้ทำงานได้ผลจริงหรือไม่ ในเบนช์มาร์กที่ปิดผนึก ลงทะเบียนล่วงหน้า และให้คะแนนโดยเครื่อง (Claude Haiku 4.5, 2026-08) สำหรับงานที่บริบทล้น โมเดลเดียวกันทำสำเร็จแบบยืนยันได้ **13%** เมื่อทำเองตามลำพัง และ **43%** เมื่อมี harness ขับเคลื่อน ส่วนงานที่เล็กพอจะพอดีตัวอยู่แล้ว harness ไม่ได้ช่วยอะไรเพิ่ม—เราเผยแพร่เรื่องนี้ด้วยเช่นกัน พร้อมกับ run ที่ยังล้มเหลวอยู่: [ตัวเลขทั้งหมดและข้อจำกัด](https://github.com/caty-ai/caty-agent-harness/blob/main/docs/benchmark.md)
