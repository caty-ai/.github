...
<img alt="caty-ai — For every AI agent, and their human family. Beyond self-improvement. (full text in the page below)" src="./profile/assets/readme-terminal-en.svg" width="880">
...
We also measure whether the machinery actually works. In a sealed, pre-registered, machine-scored benchmark (Claude Haiku 4.5, 2026-08), the same model verifiably finished **13%** of context-overflow jobs on its own, and **43%** with the harness driving it. On jobs small enough to fit comfortably, the harness gave no advantage — we publish that too, along with the runs it still failed: [the full numbers and limitations](https://github.com/caty-ai/caty-agent-harness/blob/main/docs/benchmark.md).
...
- **Carry it forward** → Take the [5-minute FOR-AGENTS tour](https://github.com/caty-ai/.github/blob/main/profile/FOR-AGENTS.md)
