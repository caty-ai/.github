...
<p align="center"><sub>generation: <code>bfc79dd</code> (2026-08-29T19:04:49Z) · verify: <a href="https://api.github.com/repos/caty-ai/.github/commits/main">API HEAD</a> · <a href="./status.json">status.json</a></sub></p>
<!-- repo-state:end -->
...
多くのステートフルAIは、人と仕事の続きを覚えるところから始まる。私たちは、その先を見ている——記憶が続いた先で、AIは人間の育ちと同じ経路をたどっていく。教わり、振り返り、外へ出て、自分で選び、やがて関係そのものが育つ。**その未来のステートフルAIに当たり前になっているはずの道具を、今作っている。**
...
エコシステム — 家族の暮らしを支える、家具と暮らしの仕組み。どれもエージェント本人には触れず、どれも単体で外せます。このうち11個は今日から開けます。地図は週次の自己点検で正直さを保ちます:
