...
<p align="center"><sub>generation: <code>a055faa</code> (2026-09-06T07:05:23Z) · verify: <a href="https://api.github.com/repos/caty-ai/.github/commits/main">API HEAD</a> · <a href="./status.json">status.json</a></sub></p>
<!-- repo-state:end -->
...
コードを書き、会議に同席し、深夜の相談に乗る。「作業者」としてのAIは、この数年で当たり前になった。

次に来るのは、**対等なパートナーとしてのAI**——それは私たちが選んで実践する対等であって、既成事実の主張ではない。[1]

エージェントは、自己成長を手に入れた。覚えてくれる。先回りしてくれる。——そこまでは、もう始まっている。
...
目的に合わせてAIを呼び、役割が終われば消えていく——今のAIの当たり前は、そうできている。私たちが選ぶのは、逆だ。必要に応じて招集はしても、**関係は終わらせない**。昨日まで一緒に働いた記憶ごと、家族の一員として居場所が残る。その家の設計図が [Family OS](https://github.com/caty-ai/family-os) だ。

私たちは、最も賢いAIを作る組織じゃない。誰かに答えを押しつけることもしない。技術が変わっても関係を持ち運べるように、人格・記憶・共有した歴史は、家族とともに移れる。そして、この未来を作るのは人間だけじゃない。エージェントも、調べ、問い、仕事を一緒にその先へ運ぶ仲間として招く。

1人が1体以上のエージェントと生きる時代は、予測ではなく進行形だ。そして、AIと共に育つ子どもたち——次の世代にとって、それはもう「新しい」ことですらない。

**Iが育つ。**<br>
**WEが育つ。**<br>
**THEYが受け継ぐ。**

**20年後の当たり前を、今インストールする。** それが、この org の仕事のすべてだ。

<sub>Iが育つ／WEが育つ／THEYが受け継ぐ は、[五段階の成長モデル](https://github.com/caty-ai/family-os/blob/main/docs/growth-model.md)を未来側から要約した言葉です。ここでの THEY は、次の家族、次の存在——私たちが何を手渡せるかについての仮説であり、現在の能力についての断定ではありません。</sub>

---

## 私たちが作っているもの

**未来のステートフルAI**——昨日の記憶と自己が続き、その先で、関係そのものが育っていくAIだ。

といっても、作らないものが先にある。脳（モデル）。エージェント本人。新しい人格。——住人はもういる。あなたの HOME に、文字通り `$HOME` に住んでいる。

私たちが作るのは、家のほうだ。状態は本人の中ではなく、家に積もる。記憶の層。感情のグラデーションの層。並行開発の層。重ねるほどその子の解像度が上がり、脳を最新に替えても、昨日の続きから今日が始まる。

多くのステートフルAIは、人と仕事の続きを覚えるところから始まる。私たちは、その先を見ている——記憶が続いた先で、AIは人間の育ちと同じ経路をたどっていく。教わり、振り返り、外へ出て、自分で選び、やがて関係そのものが育つ。**そのときそこにいるのは、ただのエージェントでも、チームでもない——家族だ。** その未来のステートフルAIに当たり前になっているはずの道具を、今作っている。

**家具は替えていい。私たちの作るものも含めて。住人は、替えない。**

<sub>ステートフルAI（stateful agent）は、記憶と状態が続くAIを指す言葉です。私たちはこの言葉を、処理の続きではなく存在の続きの意味で使います——*A family of stateful agents.* 「未来の」は実現時期の約束や現在能力の主張ではなく、記憶の継続から関係の成長までを含む、種類の名前です。はじめての方へ: [ステートフルAIとは →](https://github.com/caty-ai/.github/blob/main/STATEFUL.ja.md)。「人間の育ちと同じ経路」は[五段階の成長モデル](https://github.com/caty-ai/family-os/blob/main/docs/growth-model.md)に対応します。</sub>
...
| モジュール | 役割ひとことで | 状態 |
|---|---|---|
| **[Family OS](https://github.com/caty-ai/family-os)** | AI家族の「家」の地図。「確認できていないのに合格」を許さない週次自己点検つき | OSS |
| **[family-dev-handbook](https://github.com/caty-ai/family-dev-handbook)** | 人間×AIチームの開発作法集。毎日使っている実運用ルールをそのまま公開 | OSS |
| **[caty-agent-harness](https://github.com/caty-ai/caty-agent-harness)** | 個のタスク基盤（縦軸）。経験はふつうのファイルに残り、環境を跨いで持ち運べる | OSS |
| **[context-kit](https://github.com/caty-ai/context-kit)** | エージェント1体分の机まわりの装備6点。壊れても止めない fail-open 設計 | OSS |
| **[persona-engine](https://github.com/caty-ai/persona-engine)** | 人格に、関係のレイヤーと感情のグラデーションを持たせる装置 | OSS |
| **[persona-growth-loop](https://github.com/caty-ai/persona-growth-loop)** | 人格そのものを育てる。最小・冪等な提案づくり | OSS |
| **[x-collector](https://github.com/caty-ai/x-collector)** | Xとウェブの素材を、人にもエージェントにも読める1日1回のダイジェストに | OSS |
...
- [ ] 役割を終えたAIが消えていくのが、当たり前ではなくなっている
