...
CONTENT["ja"] = dict(
    ...
    eco=[
        ...
        ("context-kit", "repo ↗", "cyan",
         "エージェント1体分の机まわりの装備6点。大出力の退避・委譲ブリーフ検査・安全フック・記憶検索・worktree スナップショット。"),
        ("persona-engine", "repo ↗", "cyan",
         "あなたのエージェントの人格に、関係のレイヤーと感情のグラデーションを持たせる装置。"),
        ("persona-growth-loop", "repo ↗", "cyan",
...
CONTENT["en"] = dict(
    ...
    eco=[
        ...
        ("context-kit", "repo ↗", "cyan",
         "Six pieces of desk equipment: bounded output, delegation briefs, safety guards, recall, worktree snapshots."),
        ("persona-engine", "repo ↗", "cyan",
...
CONTENT["zh"] = dict(
    ...
    eco=[
        ...
        ("context-kit", "repo ↗", "cyan",
         "面向单个智能体的六件桌面装备：限定输出、委托简报校验、安全防护、记忆召回、worktree 快照。"),
        ("persona-engine", "repo ↗", "cyan",
...
CONTENT["th"] = dict(
    ...
    eco=[
        ...
        ("context-kit", "repo ↗", "cyan",
         "อุปกรณ์ประจำโต๊ะ 6 ชิ้น: จำกัดเอาต์พุต, ตรวจ brief, การ์ดความปลอดภัย, ค้นความจำ, snapshot ของ worktree"),
        ("persona-engine", "repo ↗", "cyan",
