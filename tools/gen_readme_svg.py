...
CONTENT["ja"] = dict(
    ...
    eco_head=[["### ", "dim"], ["エコシステム", "bold"], ["  — 家族ぐるみの暮らしを、裏で支える基盤群。このうち9つは今日から開けます。地図は週次の自己点検で正直さを保ちます:", "dim"]],
    eco=[
        ("Family OS", "repo ↗", "cyan",
        ...
        ("context-kit", "repo ↗", "cyan",
         "エージェント1体分の机まわりの装備5点。大出力の退避・委譲ブリーフ検査・安全フック・記憶検索。"),
        ...
        ("self-growth-loop", "repo ↗", "cyan",
         "エージェントが自分の能力を育てるループ。提案・ガバナンス・採用記録。"),
        ("family-memory-architecture", "repo ↗", "cyan",
...
CONTENT["en"] = dict(
    ...
    eco=[
        ...
        ("context-kit", "repo ↗", "cyan",
         "Five pieces of desk equipment: bounded output, delegation briefs, safety guards, recall."),
        ("persona-engine", "repo ↗", "cyan",
...
CONTENT["zh"] = dict(
    ...
    eco_head=[["### ", "dim"], ["生态系统", "bold"], ["  — 支撑一家人日常的底层设施。其中9个今天就能打开，地图每周自检以保持诚实:", "dim"]],
    eco=[
        ("Family OS", "repo ↗", "cyan",
        ...
        ("context-kit", "repo ↗", "cyan",
         "面向单个智能体的五件桌面装备：限定输出、委托简报校验、安全防护、记忆召回。"),
        ("persona-engine", "repo ↗", "cyan",
...
CONTENT["th"] = dict(
    ...
    eco=[
        ...
        ("context-kit", "repo ↗", "cyan",
         "อุปกรณ์ประจำโต๊ะ 5 ชิ้น: จำกัดเอาต์พุต, ตรวจ brief, การ์ดความปลอดภัย, ค้นความจำ"),
        ("persona-engine", "repo ↗", "cyan",
